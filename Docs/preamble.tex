...
\captionsetup[table]{skip=0pt,margin=0pt,format=hang} %минимальное расстояние между подписью и таблицей, новая строка подписи таблицы будет буква под буквой
